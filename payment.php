...
<head>
  ...
  <title>DairyFarm | Payment Details</title>
                  ...
                  <tr>
                   ...
                   <tbody>
                      <?php
                       ...
                       $product= mysqli_query($connection, "select * from  tbl_payment") or die(mysqli_error($connection));
                       
                       while($row = mysqli_fetch_array($product)){
                           echo "<tr>";
                           echo "<th>{$row['payment_id ']}</th>"; 
                           echo "<th>{$row['user_id ']}</th>"; 
                           echo "<th>{$row['pay_date']}</th>"; 
                           echo "<th>{$row['pay_amount']}</th>"; 
                           echo "<th>{$row['note']}</th>"; 
                            echo '<th><html>
