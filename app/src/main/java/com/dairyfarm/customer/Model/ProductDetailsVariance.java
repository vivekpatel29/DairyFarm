...
public class ProductDetailsVariance {
    String AttributeID, AttributeString, AttributeGroupID, AtttributeGroupName, AttributeValueID, AttributeValueName, MarketPrice, SellingPrice, AddToCart, CartString, isActive, CartID, CartQty, ManageStock, StockQty, WishlistID, SavingPrice, SavingPercentage, ImagePath, ThumbPath, HasOffer, OfferString, OfferID, isFeatured, FeatureString, ShareLink;
    ArrayList<ProductDetailsImage> listImages;

    public ProductDetailsVariance(String attributeID, String attributeString, String attributeGroupID, String atttributeGroupName, String attributeValueID, String attributeValueName, String marketPrice, String sellingPrice, String addToCart, String cartString, String isActive, String cartID, String cartQty, String manageStock, String stockQty, String wishlistID, String savingPrice, String savingPercentage, String imagePath, String thumbPath, String hasOffer, String offerString, String offerID, String isFeatured, String featureString, String shareLink, ArrayList<ProductDetailsImage> listImages) {
    ...
    public ArrayList<ProductDetailsImage> getListImages() {
        return listImages;
    }

    public void setListImages(ArrayList<ProductDetailsImage> listImages) {
        this.listImages = listImages;
    }
}
