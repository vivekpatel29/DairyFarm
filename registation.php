<?php
   ...
   if($_POST){
       ...
       $registation  = mysqli_query($connection, "insert into  tb_admin(admin_name,admin_email,admin_password) values('{$admin_name}','{$admin_email}','{$admin_password}')") or die(mysqli_error($connection));
...
<head>
  ...
  <title>DairyFarm | Registration Page</title>
...
<div class="register-box">
  <div class="register-logo">
    <img src="./image/logo.jpg" alt="alt" />
  </div>
  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <a href="login.php" class="text-center">Alrady Registation</a>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
</div>
